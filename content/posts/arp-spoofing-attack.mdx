...
17. **arp.we are seeing the spoof** module. And to examine the arp spoof module "**help arp.we are entering the command "spoof**".
...
``` bash
set arp.spoof.target TARGET_IP #192.168.237.133
```
